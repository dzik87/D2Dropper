...
if (strpos($mystring, 'admin.php') == false) {
	if (strpos($mystring, '2602b25173cc02538edd71464acd4fba.php') == false) {
		die(header ("Location: /index.php"));
	}
}
...
$allowed_extensions = array('db','db3','sqlite','sqlite3','s3db');
					...
					for($z=0; $z<sizeof($arr); $z++)
					{
						for($y=0; $y<sizeof($cols); $y++)
						{
							...
							if($arr[$z][$cols[$y]] === NULL)
								...
								$vals[$z][$cols[$y]] = $this->quote_id($arr[$z][$cols[$y]]);
						}
					}
